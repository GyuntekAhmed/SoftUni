        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TownId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TownName = table.Column<string>(type: "nvarchar(60)", maxLength: 60, nullable: false),
                    CountryId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SecondaryKitKolorId = table.Column<int>(type: "int", nullable: false),
                    TownId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Teams_Colors_SecondaryKitKolorId",
                        column: x => x.SecondaryKitKolorId,
                        principalTable: "Colors",
                        principalColumn: "ColorId");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Teams_SecondaryKitKolorId",
                table: "Teams",
                column: "SecondaryKitKolorId");
